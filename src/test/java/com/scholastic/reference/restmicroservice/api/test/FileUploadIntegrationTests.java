/*package com.scholastic.reference.restmicroservice.api.test;
...
import com.scholastic.dw.uploader.storage.StorageService;
...
public class FileUploadIntegrationTests {
    ...
    public void shouldUploadFile() throws Exception {
        ...
        ResponseEntity<String> response = this.restTemplate.postForEntity("/fileupload", map, String.class);
